...
import com.ibenben.config.quartz.QuartzJobFactory;
import com.ibenben.config.quartz.QuartzJobFactoryDisallowConcurrentExecution;
import com.ibenben.domain.ScheduleJob;
import com.ibenben.mapper.ScheduleJobMapper;
...
public class JobTaskService {
	 ...
	 * 任务是否存在
	 */
	public boolean isExist(ScheduleJob sj){
		if(scheduleJobMapper.isExist(sj) > 0){
			return true;
		}
		return false;
	}
